...
namespace OneAtmos.Pages.PageConstants
{
    class OneAtmosMyAccountLocators
    {
        ...
        public static By From_Calendar_Invoicing = By.XPath("//div[contains(@class,'xx-small')]//div[contains(@class,'slds-wrap')]//div[1]//div[1]//div[1]//input[1]");
        public static By To_Calendar_Invoicing = By.XPath("//div[contains(@class,'xx-small')]//div[contains(@class,'slds-wrap')]//div[2]//div[1]//div[1]//input[1]");
